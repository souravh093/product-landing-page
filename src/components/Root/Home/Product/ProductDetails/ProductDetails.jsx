...
const ProductDetails = () => {
    ...
    const {title, price,  thumbnail, rating, description} = products;
    return (
            <section className="text-gray-700 body-font overflow-hidden bg-white min-h-[calc(100vh-323px)]">
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={thumbnail} />
